...
class _SkillSwapBottomSheetState extends State<SkillSwapBottomSheet>
  ...
  void _showSnack(String msg, {bool isError = false}) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Row(children: [
        ...
        Expanded(child: Text(msg, style: GoogleFonts.poppins(fontWeight: FontWeight.w500, fontSize: 13))),
      ]),
      backgroundColor: isError ? Colors.red.shade600 : const Color(0xFF333333),
      ...
      child: Column(children: [
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(children: [
                Text('Skill Swap', style: GoogleFonts.poppins(fontSize: 17, fontWeight: FontWeight.bold)),
                Text('Powered by LifeKit AI', style: GoogleFonts.poppins(fontSize: 11, color: AppColors.primary)),
              ]),
            ),
            GestureDetector(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (_, __) => SizedBox(
                    ...
                    child: Stack(alignment: Alignment.center, children: [
                      ...
                      Positioned(
                        left: 8, top: 20 + _floatAnim.value,
                        child: Transform.rotate(
                          angle: -0.18,
                          child: _buildCardTile(
                            imageUrls: selectedMyService?['image_urls'] ?? [],
                            color: _kGold, isTarget: false,
                          ),
                        ),
                      ),
                      Positioned(
                        right: 8, top: 20 - _floatAnim.value,
                        child: Transform.rotate(
                          angle: 0.18,
                          child: _buildCardTile(imageUrls: [], color: _kBlue, isTarget: true),
                        ),
                      ),
                      Container(
                        width: 34, height: 34,
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                _buildSelectionChip(
                  ...
                  filled: true, onTap: _showMyServicesPicker,
                ),
                Padding(
                  ...
                  child: Container(
                    width: 28, height: 28,
                    decoration: BoxDecoration(color: Colors.grey[100], shape: BoxShape.circle),
                    child: const Icon(Icons.sync, size: 16, color: Colors.grey),
                  ),
                ),
                _buildSelectionChip(
                  label: selectedTargetSubCategory?['name'] ?? 'Select Target',
                  filled: false, onTap: _showCategoryPicker,
                ),
              ]),

              const SizedBox(height: 28),

              Text('Looking for a skill',
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    Icon(Icons.search,
                        color: selectedTargetSubCategory != null ? AppColors.primary : Colors.grey[400],
                        size: 20),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Text(
                        selectedTargetSubCategory?['name'] ?? 'Search for a skill\u2026',
                        style: GoogleFonts.poppins(
                          fontSize: 14,
                          color: selectedTargetSubCategory != null ? Colors.black87 : Colors.grey[400],
                        ),
                    ...
                    if (selectedTargetSubCategory != null)
                      GestureDetector(
                        onTap: () => setState(() => selectedTargetSubCategory = null),
              ...
              Container(
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(
                    child: RichText(
                      text: TextSpan(
                        style: GoogleFonts.poppins(fontSize: 11, color: Colors.black54, height: 1.55),
                        children: const [
                          TextSpan(text: 'Bi-directional AI matching ',
                              style: TextStyle(fontWeight: FontWeight.w700, color: AppColors.primary)),
                          TextSpan(text: 'finds providers who want what you offer AND offer what you want.'),
                        ],
                      ),
                    ),
                  ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text('Find AI Match', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w600)),
                    const SizedBox(width: 8),
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (_) => const SwapBoardScreen()));
                  },
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    const SizedBox(width: 8),
                    Text('Browse Swap Board', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w600)),
                  ]),
                ),
              ),
            ]),
  ...
  Widget _buildCardTile({required List imageUrls, required Color color, required bool isTarget}) {
    final String? imageUrl = (!isTarget && imageUrls.isNotEmpty) ? imageUrls[0] : null;
    return Container(
      width: 82, height: 108,
      decoration: BoxDecoration(
        color: color,
      ...
      child: isTarget ? const Center(child: Icon(Icons.question_mark, color: Colors.white, size: 38)) : null,
    );
  }

  Widget _buildSelectionChip({required String label, required bool filled, required VoidCallback onTap}) {
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 16),
          Text('Select a skill to offer', style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16)),
          const SizedBox(height: 12),
          Expanded(
            child: myServices.isEmpty
                ? Center(child: Text('No services found. Create a service first.', style: GoogleFonts.poppins(color: Colors.grey, fontSize: 13)))
                : ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return ListTile(
                        ...
                        leading: CircleAvatar(
                          ...
                          backgroundImage: isImg ? CachedNetworkImageProvider(s['image_urls'][0]) : null,
                          child: !isImg ? Text(s['title'][0], style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: AppColors.primary)) : null,
                        ),
                        title: Text(s['title'], style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w500)),
                        trailing: selectedMyService?['id'] == s['id']
                            ? const Icon(Icons.check_circle, color: AppColors.primary, size: 20) : null,
                        onTap: () { setState(() => selectedMyService = s); Navigator.pop(context); },
                      );
                    },
                  ),
          ),
        ...
        builder: (_) => DraggableScrollableSheet(
          ...
          builder: (_, controller) => Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Center(child: Container(width: 40, height: 4, decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(2)))),
              const SizedBox(height: 16),
              Text('Select Skill Category', style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16)),
              const SizedBox(height: 12),
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) => ListTile(
                    contentPadding: EdgeInsets.zero,
                    title: Text(cats[i]['name'], style: GoogleFonts.poppins(fontSize: 14)),
                    trailing: const Icon(Icons.arrow_forward_ios, size: 13, color: Colors.grey),
                    onTap: () { Navigator.pop(context); _handleCategorySelect(cats[i]); },
                  ),
                ),
              ),
            ]),
  ...
  void _handleCategorySelect(dynamic parentCat) async {
    try {
      ...
      if (!mounted) return;
      if (subs.isEmpty) { setState(() => selectedTargetSubCategory = parentCat); }
      else { _showSubCategoryPicker(subs, parentCat['name']); }
    } catch (_) { setState(() => selectedTargetSubCategory = parentCat); }
  }
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Center(child: Container(width: 40, height: 4, decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(2)))),
          const SizedBox(height: 16),
          Text('Specific skill in $parentName', style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16)),
          const SizedBox(height: 12),
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (_, i) => ListTile(
                contentPadding: EdgeInsets.zero,
                title: Text(subs[i]['name'], style: GoogleFonts.poppins(fontSize: 14)),
                onTap: () { setState(() => selectedTargetSubCategory = subs[i]); Navigator.pop(context); },
              ),
            ),
          ),
        ]),
...
class FindingMatchAnimationScreen extends StatefulWidget {
  ...
  @override
  State<FindingMatchAnimationScreen> createState() => _FindingMatchAnimationScreenState();
}

class _FindingMatchAnimationScreenState extends State<FindingMatchAnimationScreen>
  ...
  final List<IconData> _orbitIcons = [
    Icons.build_rounded, Icons.school_rounded, Icons.brush_rounded,
    Icons.restaurant_rounded, Icons.fitness_center_rounded, Icons.music_note_rounded,
  ];
  ...
  void initState() {
    ...
    _slideCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 1400));
    _leftX = Tween<double>(begin: -280, end: -58).animate(CurvedAnimation(parent: _slideCtrl, curve: Curves.easeOutBack));
    _rightX = Tween<double>(begin: 280, end: 58).animate(CurvedAnimation(parent: _slideCtrl, curve: Curves.easeOutBack));
    _scale = Tween<double>(begin: 0.75, end: 1.0).animate(CurvedAnimation(parent: _slideCtrl, curve: const Interval(0.6, 1.0)));
    _leftRot = Tween<double>(begin: 0.4, end: -0.15).animate(CurvedAnimation(parent: _slideCtrl, curve: Curves.easeOutBack));
    _rightRot = Tween<double>(begin: -0.4, end: 0.15).animate(CurvedAnimation(parent: _slideCtrl, curve: Curves.easeOutBack));

    _pulseCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 1600))..repeat();
    _pulseScale = Tween<double>(begin: 0.7, end: 1.6).animate(CurvedAnimation(parent: _pulseCtrl, curve: Curves.easeOut));
    ...
    _sparkleCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 900));

    _scanCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 1800))..repeat(reverse: true);
    _scanY = Tween<double>(begin: -80, end: 80).animate(CurvedAnimation(parent: _scanCtrl, curve: Curves.easeInOut));
    ...
    _slideCtrl.forward().then((_) {
      Future.delayed(const Duration(milliseconds: 600), () {
        if (mounted) {
          setState(() { _isMatched = true; _showBurst = true; });
  ...
  void _initParticles() {
    ...
    for (int i = 0; i < 35; i++) {
      _particles.add(_Particle(
        x: rng.nextDouble() * 400, y: rng.nextDouble() * 700,
        vx: (rng.nextDouble() - 0.5) * 1.2, vy: (rng.nextDouble() - 0.5) * 1.2,
        size: rng.nextDouble() * 4 + 1.5, opacity: rng.nextDouble() * 0.5 + 0.1,
        color: [AppColors.primary, _kGold, _kBlue, Colors.purpleAccent][rng.nextInt(4)],
      ));
    }
  }
  ...
  void _updateParticles() {
    ...
    setState(() {
      for (final p in _particles) {
        ...
        if (p.y < 0) p.y = 700; if (p.y > 700) p.y = 0;
        p.opacity = 0.1 + math.sin(_particleCtrl.value * math.pi * 2 + rng.nextDouble()) * 0.2;
      }
    });
  }
  ...
  @override
  void dispose() {
    _slideCtrl.dispose(); _pulseCtrl.dispose(); _orbitCtrl.dispose();
    _sparkleCtrl.dispose(); _scanCtrl.dispose(); _particleCtrl.dispose();
    _textCtrl.dispose(); _textTimer?.cancel();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    final String? myImg = (widget.myService['image_urls'] as List).isNotEmpty
        ? widget.myService['image_urls'][0] : null;
    ...
    return Scaffold(
      ...
      body: Stack(alignment: Alignment.center, children: [
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                border: Border.all(
                  color: AppColors.primary.withOpacity(_pulseOpacity.value.clamp(0.0, 1.0)),
                  width: 2,
                ),
              ),
            ),
            ...
            builder: (_, __) => SizedBox(
              ...
              child: Stack(
                ...
                children: List.generate(_orbitIcons.length, (i) {
                  final angle = _orbitCtrl.value * 2 * math.pi + (i / _orbitIcons.length) * 2 * math.pi;
                  final r = 120.0;
                  final x = math.cos(angle) * r;
                  final y = math.sin(angle) * r;
                  return Positioned(
                    left: 130 + x - 14, top: 130 + y - 14,
                    child: Container(
                      width: 28, height: 28,
                      decoration: BoxDecoration(
                      ...
                      child: Icon(_orbitIcons[i], color: AppColors.primary.withOpacity(0.7), size: 14),
                    ),
                  );
                }),
              ),
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [
                    Colors.transparent, AppColors.primary.withOpacity(0.8), Colors.transparent,
                  ]),
                ),
              ),
            ),
          ...
          builder: (_, __) => Align(
            ...
            child: Transform.translate(
              ...
              child: Transform.rotate(
                ...
                child: Transform.scale(scale: _scale.value, child: _buildCard(myImg, _kGold, false)),
              ),
            ),
          ),
        ),
          ...
          builder: (_, __) => Align(
            ...
            child: Transform.translate(
              ...
              child: Transform.rotate(
                ...
                child: Transform.scale(scale: _scale.value, child: _buildCard(null, _kBlue, true)),
              ),
            ),
          ),
        ),
                ...
                return Positioned(
                  ...
                  child: Opacity(
                    ...
                    child: Container(
                      width: 10, height: 10,
                      decoration: BoxDecoration(
                        color: [_kGold, AppColors.primary, _kBlue, Colors.purpleAccent][i % 4],
                        shape: BoxShape.circle,
                      ),
                    ),
                  ),
        ...
        // Status text
        Positioned(
          bottom: size.height * 0.2, left: 40, right: 40,
          child: AnimatedSwitcher(
            ...
            child: _isMatched
                ? Column(key: const ValueKey('matched'), children: [
                    ...
                    const SizedBox(height: 16),
                    Text('Match Found!', style: GoogleFonts.poppins(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)),
                    const SizedBox(height: 4),
                    Text('Loading your results\u2026', style: GoogleFonts.poppins(fontSize: 13, color: Colors.white.withOpacity(0.6))),
                  ])
                : Column(key: const ValueKey('searching'), children: [
                    SizedBox(
                      width: 32, height: 32,
                    ...
                    AnimatedBuilder(
                      ...
                      builder: (_, __) => Opacity(
                        ...
                        child: Text(_searchTexts[_searchTextIndex],
        ...
        Positioned(
          ...
          child: Column(children: [
            Text('AI matching for', style: GoogleFonts.poppins(fontSize: 12, color: Colors.white.withOpacity(0.5))),
            const SizedBox(height: 6),
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 8),
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [AppColors.primary.withOpacity(0.3), _kBlue.withOpacity(0.3)]),
                borderRadius: BorderRadius.circular(24),
                border: Border.all(color: AppColors.primary.withOpacity(0.5)),
              ),
              child: Text(widget.targetCategoryName,
  ...
  Widget _buildCard(String? url, Color color, bool isQuestion) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: color.withOpacity(0.6), blurRadius: 24, offset: const Offset(0, 10))],
        image: url != null
            ? DecorationImage(image: CachedNetworkImageProvider(url), fit: BoxFit.cover)
            : null,
      ),
      child: isQuestion
          ? Center(child: Icon(Icons.auto_awesome, color: Colors.white.withOpacity(0.8), size: 48))
          : null,
    );
  }
}
...
class _SkillSwapResultsScreenState extends State<SkillSwapResultsScreen> {
  ...
  void _showSnack(String msg, {bool isError = false, bool isSuccess = false}) {
    final color = isError ? Colors.red.shade600 : isSuccess ? Colors.green.shade600 : const Color(0xFF333333);
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Row(children: [
        Icon(isError ? Icons.error_outline : isSuccess ? Icons.check_circle_outline : Icons.info_outline,
            color: Colors.white, size: 18),
        const SizedBox(width: 10),
        Expanded(child: Text(msg, style: GoogleFonts.poppins(fontWeight: FontWeight.w500, fontSize: 13))),
      ]),
  ...
  Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        body: Center(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            const SizedBox(height: 16),
            Text('No providers found', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.grey)),
            const SizedBox(height: 8),
            Text('Try a different skill category', style: GoogleFonts.poppins(fontSize: 13, color: Colors.grey[400])),
          ]),
        ),
      );
    }
    ...
    final String matchReason = primaryMatch!['match_reason'] ?? 'Good complementary match';
    final similarList = allMatches.where((s) => s['id'] != primaryMatch!['id']).toList();
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Column(children: [
            Text('AI Matched', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black87)),
            Text(widget.targetCategoryName, style: GoogleFonts.poppins(fontSize: 11, color: AppColors.primary)),
          ]),
          centerTitle: true,
          actions: [
            Padding(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [AppColors.primary.withOpacity(0.1), _kBlue.withOpacity(0.08)]),
                borderRadius: BorderRadius.circular(14),
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Row(children: [
                      Text('AI Match Score: ', style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.black54)),
                      Text('${matchScore.toStringAsFixed(0)}%',
                          style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w800, color: AppColors.primary)),
                    ]),
                    Text(matchReason, style: GoogleFonts.poppins(fontSize: 11, color: Colors.black54, height: 1.4)),
                  ]),
                ),
            ...
            Container(
              ...
              child: Column(children: [
                  ...
                  child: Stack(alignment: Alignment.center, children: [
                    Transform.translate(
                      ...
                      child: Transform.rotate(
                        angle: -0.12,
                        child: _buildImgCard(
                          (widget.myService['image_urls'] as List).isNotEmpty ? widget.myService['image_urls'][0] : null,
                          _kGold,
                        ),
                      ),
                    ),
                    Transform.translate(
                      ...
                      child: Transform.rotate(
                        angle: 0.12,
                        child: _buildImgCard(
                          (primaryMatch!['image_urls'] as List).isNotEmpty ? primaryMatch!['image_urls'][0] : null,
                          _kBlue,
                        ),
                      ),
                    ),
                    Container(
                      ...
                      child: const Icon(Icons.swap_horiz, color: AppColors.primary, size: 16),
                    ),
                  ]),
                ),
                ...
                _buildPartyRow(
                  pic: currentUserPic, name: currentUserName, serviceTitle: widget.myService['title'],
                  tag: 'Me', tagColor: Colors.grey[100]!,
                ),
                ...
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    Container(
                      ...
                      child: const Icon(Icons.swap_vert, color: AppColors.primary, size: 18),
                    ),
                    Expanded(child: Divider(color: Colors.grey.shade200)),
                  ]),
                ),
                ...
                _buildPartyRow(
                  pic: providerPic, name: providerName, serviceTitle: primaryMatch!['title'],
                  tag: 'Match', tagColor: AppColors.primary.withOpacity(0.1),
                  tagTextColor: AppColors.primary,
                  onTap: () => Navigator.push(context, MaterialPageRoute(
                    builder: (_) => ProviderProfileScreen(
                      providerId: providerId, providerName: providerName, providerPic: providerPic,
                    ),
                  )),
              ...
              Container(
                ...
                child: Column(children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('Other AI Matches', style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w600)),
                    Text('${similarList.length} found', style: GoogleFonts.poppins(fontSize: 12, color: AppColors.primary, fontWeight: FontWeight.w500)),
                  ]),
                  const SizedBox(height: 14),
                  SizedBox(
                    height: 92,
                    child: ListView.separated(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        final pic = s['profiles']?['profile_picture_url'] ??
                            ((s['image_urls'] as List).isNotEmpty ? s['image_urls'][0] : null);
                          ...
                          child: Column(children: [
                            AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: pic != null
                                    ? DecorationImage(image: CachedNetworkImageProvider(pic), fit: BoxFit.cover)
                                    : null,
                              ),
                              child: pic == null
                            ...
                            const SizedBox(height: 4),
                            Text(name.split(' ')[0], textAlign: TextAlign.center,
                                style: GoogleFonts.poppins(fontSize: 10, fontWeight: FontWeight.w500)),
                            Text('${sScore.toStringAsFixed(0)}%',
                                style: GoogleFonts.poppins(fontSize: 9, color: AppColors.primary, fontWeight: FontWeight.w600)),
                          ]),
                        );
                      },
                    ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  const SizedBox(width: 8),
                  Text('Send Swap Proposal', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w600)),
                ]),
              ),
            ),
          ]),
  ...
  Widget _buildPartyRow({
    required String? pic, required String name, required String serviceTitle,
    required String tag, required Color tagColor, Color? tagTextColor,
    ...
    return GestureDetector(
      ...
      child: Row(children: [
        CircleAvatar(
          ...
          child: pic == null ? Text(name[0].toUpperCase(),
              style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: AppColors.primary)) : null,
        ),
        const SizedBox(width: 12),
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(serviceTitle, style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 13),
                maxLines: 1, overflow: TextOverflow.ellipsis),
            Text(name, style: GoogleFonts.poppins(color: Colors.grey, fontSize: 11)),
          ]),
        ),
        ...
        Container(
          ...
          child: Text(tag, style: GoogleFonts.poppins(fontSize: 10, fontWeight: FontWeight.bold,
...
class _ScoreRing extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = score >= 0.75 ? Colors.green : score >= 0.5 ? AppColors.primary : Colors.orange;
    return SizedBox(
      width: 42, height: 42,
      child: Stack(alignment: Alignment.center, children: [
        CircularProgressIndicator(
          value: score, backgroundColor: Colors.grey.shade200,
          valueColor: AlwaysStoppedAnimation(color), strokeWidth: 4,
        ),
...
class _SwapProposalSheet extends StatefulWidget {
  ...
  const _SwapProposalSheet({
    required this.myService, required this.targetMatch,
    required this.targetCategoryName, required this.onSent,
  });
...
class _SwapProposalSheetState extends State<_SwapProposalSheet> {
  ...
  @override
  Widget build(BuildContext context) {
    final providerName = widget.targetMatch['profiles']?['full_name'] ?? 'Unknown';
    return Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [AppColors.primary.withOpacity(0.15), _kBlue.withOpacity(0.1)]),
                  borderRadius: BorderRadius.circular(14),
                ),
                child: const Icon(Icons.handshake_outlined, color: AppColors.primary, size: 24),
              ),
              const SizedBox(width: 14),
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Send Swap Proposal', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold)),
                  Text('to $providerName', style: GoogleFonts.poppins(fontSize: 12, color: Colors.grey)),
                ]),
              ),
            ]),
            ...
            Container(
              ...
              child: Row(children: [
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('You offer', style: GoogleFonts.poppins(fontSize: 10, color: Colors.grey)),
                    Text(widget.myService['title'], style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w700)),
                  ]),
                ),
                Container(
                  width: 30, height: 30,
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    Text('You receive', style: GoogleFonts.poppins(fontSize: 10, color: Colors.grey)),
                    Text(widget.targetMatch['title'],
            ...
            Text('Preferred Date', style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w600)),
            const SizedBox(height: 10),
            isLoadingDates
                ? const Center(child: CircularProgressIndicator(strokeWidth: 2))
                : availableDates.isEmpty
                    ? Text('No availability found \u2014 proposal will be sent without a date.',
                        ...
                        children: availableDates.map((d) {
                          ...
                          return GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: isSelected ? AppColors.primary.withOpacity(0.07) : const Color(0xFFF7F7F9),
                              ...
                              child: Row(children: [
                                Expanded(
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Text(d['label'], style: GoogleFonts.poppins(
                                        fontSize: 13, fontWeight: FontWeight.w600,
                                        color: isSelected ? AppColors.primary : Colors.black87)),
                                    Text(d['time'], style: GoogleFonts.poppins(fontSize: 11, color: Colors.grey[500])),
                                  ]),
                                ),
                                Icon(
                                  isSelected ? Icons.check_circle_rounded : Icons.circle_outlined,
                                  color: isSelected ? AppColors.primary : Colors.grey[300], size: 20,
                                ),
                              ]),
                            ),
                          );
            ...
            Text('Note (optional)', style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w600)),
            const SizedBox(height: 8),
            TextField(
              controller: _notesCtrl, maxLines: 3, maxLength: 250,
              decoration: InputDecoration(
                hintText: 'E.g. "Happy to be flexible on timing, let me know!"',
              ...
              child: ElevatedButton(
                ...
                child: isSending
                    ...
                    : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        const SizedBox(width: 8),
                        Text('Send Proposal', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w600)),
                      ]),
              ),
            ),
          ]),
...
class _SwapBoardScreenState extends State<SwapBoardScreen>
  ...
  Future<void> _loadBoard() async {
    try {
      final data = await _apiService.getAiRankedSwapBoard();
      if (mounted) setState(() { boardItems = data; isLoadingBoard = false; });
    } catch (_) {
  ...
  Future<void> _loadMine() async {
    try {
      final results = await Future.wait([_apiService.getIncomingSwaps(), _apiService.getOutgoingSwaps()]);
      if (mounted) {
        setState(() {
          incomingSwaps = results[0];
          outgoingSwaps = results[1];
          isLoadingMine = false;
        });
      }
    } catch (_) {
  ...
  void _showSnack(String msg, {bool isError = false, bool isSuccess = false}) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      ...
      backgroundColor: isError ? Colors.red.shade600 : isSuccess ? Colors.green.shade600 : const Color(0xFF333333),
      behavior: SnackBarBehavior.floating,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
      margin: const EdgeInsets.all(16),
    ));
  ...
  @override
  Widget build(BuildContext context) {
    final pendingCount = incomingSwaps.where((s) => s['status'] == 'pending').length;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Swap Board', style: GoogleFonts.poppins(fontSize: 17, fontWeight: FontWeight.bold, color: Colors.black87)),
          Text('AI-ranked matches for you', style: GoogleFonts.poppins(fontSize: 11, color: AppColors.primary)),
        ]),
        bottom: TabBar(
          controller: _tabCtrl,
        ...
        children: [
          RefreshIndicator(
            ...
            child: isLoadingBoard
                ...
                : boardItems.isEmpty
                    ? _buildEmpty('No swap posts yet', 'Be the first to post a swap!', Icons.dashboard_customize_outlined)
                    : ListView.builder(
                        padding: const EdgeInsets.fromLTRB(16, 16, 16, 32),
                        itemCount: boardItems.length,
                        itemBuilder: (_, i) => _buildBoardCard(boardItems[i]),
                      ),
          ),
          RefreshIndicator(
            color: AppColors.primary,
            ...
            child: isLoadingMine
                ...
                : incomingSwaps.isEmpty
                    ? _buildEmpty('No incoming proposals', 'Proposals will appear here', Icons.inbox_outlined)
                    : ListView.builder(
                        padding: const EdgeInsets.fromLTRB(16, 16, 16, 32),
          ...
          RefreshIndicator(
            ...
            child: isLoadingMine
                ...
                : outgoingSwaps.isEmpty
                    ? _buildEmpty('No outgoing proposals', 'Start by finding a match!', Icons.send_outlined)
                    : ListView.builder(
                        padding: const EdgeInsets.fromLTRB(16, 16, 16, 32),
        ...
        if (images.isNotEmpty)
          ClipRRect(
            ...
            child: CachedNetworkImage(
              imageUrl: images[0], height: 120, width: double.infinity, fit: BoxFit.cover,
              placeholder: (_, __) => Container(height: 120, color: Colors.grey[100]),
            ),
          ),
        Padding(
          padding: const EdgeInsets.all(14),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              CircleAvatar(
                ...
                backgroundImage: pic != null ? CachedNetworkImageProvider(pic) : null,
                child: pic == null ? Text(name[0].toUpperCase(),
                    style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: AppColors.primary, fontSize: 12)) : null,
              ),
              const SizedBox(width: 10),
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(name, style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 13)),
                  Text(_timeAgo(item['created_at']), style: GoogleFonts.poppins(fontSize: 10, color: Colors.grey)),
                ]),
              ),
              Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text('${relevance.toStringAsFixed(0)}% match',
            ...
            Row(children: [
              _offerWantChip('\u{1F4E6} Offers', service['title'] ?? '\u2014', _kGold),
              const SizedBox(width: 8),
              _offerWantChip('\u{1F50D} Wants', item['target_category_name'] ?? '\u2014', _kBlue),
            ]),
            ...
            if (reason.isNotEmpty) ...[
              ...
              Container(
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Icon(Icons.lightbulb_outline_rounded, size: 13, color: Color(0xFF1A78C2)),
                  const SizedBox(width: 6),
                  Expanded(child: Text(reason, style: GoogleFonts.poppins(fontSize: 11, color: const Color(0xFF1A2D40), height: 1.4))),
                ]),
              ),
            ],
  ...
  Widget _buildIncomingCard(dynamic swap) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white, borderRadius: BorderRadius.circular(18),
        border: isPending ? Border.all(color: AppColors.primary.withOpacity(0.3), width: 1.5) : null,
        boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.04), blurRadius: 12, offset: const Offset(0, 4))],
      ),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('wants to swap with you', style: GoogleFonts.poppins(fontSize: 11, color: Colors.grey)),
            ]),
          ),
          _statusPill(status),
        ]),
        ...
        Row(children: [
          _offerWantChip('\u{1F4E6} Their Offer', service['title'] ?? '\u2014', _kGold),
          const SizedBox(width: 8),
          _offerWantChip('\u{1F50D} Wants', swap['target_category_name'] ?? '\u2014', _kBlue),
        ]),

        if (swap['notes'] != null && (swap['notes'] as String).isNotEmpty) ...[
          const SizedBox(height: 8),
          Text('"${swap['notes']}"',
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(name, style: GoogleFonts.poppins(fontWeight: FontWeight.w700, fontSize: 14)),
              Text(_timeAgo(swap['created_at']), style: GoogleFonts.poppins(fontSize: 11, color: Colors.grey)),
            ]),
          ),
          _statusPill(status),
        ]),
        ...
        const SizedBox(height: 12),
        Row(children: [
          _offerWantChip('\u{1F4E6} You Offered', service['title'] ?? '\u2014', _kGold),
          const SizedBox(width: 8),
          _offerWantChip('\u{1F50D} Wanted', swap['target_category_name'] ?? '\u2014', _kBlue),
        ]),
        ...
        if (status == 'pending') ...[
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              child: Text('Cancel Proposal', style: GoogleFonts.poppins(fontWeight: FontWeight.w600)),
            ),
          ),
        ],
      ]),
  ...
  Widget _statusPill(String status) {
    ...
    switch (status) {
      case 'accepted': bg = Colors.green.shade50; fg = Colors.green.shade700; label = '\u2713 Accepted'; break;
      case 'declined': bg = Colors.red.shade50; fg = Colors.red.shade700; label = '\u2717 Declined'; break;
      case 'cancelled': bg = Colors.grey.shade100; fg = Colors.grey; label = 'Cancelled'; break;
      default: bg = AppColors.primary.withOpacity(0.1); fg = AppColors.primary; label = '\u23F3 Pending';
    }
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
  ...
  Widget _buildEmpty(String title, String sub, IconData icon) {
    return Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const SizedBox(height: 12),
        Text(title, style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.grey)),
        const SizedBox(height: 6),
        Text(sub, style: GoogleFonts.poppins(fontSize: 12, color: Colors.grey[400])),
      ]),
    );
  }
